...
// rules: D-03 safe default = 2 x 2kg packs OR 4kg total (immutable per version)
...
console.log(JSON.stringify({ campaign: campaign.code, status: "active", version: versionId, outlets: domain.listOutlets().length }, null, 2));
db.close();